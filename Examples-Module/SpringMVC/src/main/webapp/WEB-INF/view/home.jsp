...
<%@ page import="by.nc.school.dev.example.spring.mvc.service.AppStringsService" %>
<%@ page import="by.nc.school.dev.example.spring.mvc.web.Pages" %>
...
<div class="container">
    ...
    <table class="table">
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col"><app:app-string key="<%=AppStringsService.WEB.LOGIN.USER.KEY%>"/></th>
                <th scope="col"><app:app-string key="<%=AppStringsService.WEB.LOGIN.PASSWORD.KEY%>"/></th>
            </tr>
        </thead>
