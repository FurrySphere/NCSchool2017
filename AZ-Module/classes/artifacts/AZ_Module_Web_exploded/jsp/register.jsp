        ...
        <section>
            <form name="Registration" action="${pageContext.request.contextPath}/controller" method="POST">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input id="username" type="text" class="username form-control" name="login"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="telephoneNumber">Email: <span class="red">*</span></label>
                            <input id="telephoneNumber" type="text" class="form-control" name="telephoneNumber"
                                   pattern="{3,16}$" required="">
                        </div>
                    </div>
                </div>
